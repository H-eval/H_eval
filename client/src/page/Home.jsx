...
//   return (
//     <div className="flex flex-col min-h-screen font-inter text-white scroll-smooth">
//       {/* Background */}
//       <BackgroundWords />

//       {/* Navbar */}
//       <header className="bg-black/70 backdrop-blur-lg transition-all">
...
//               </div>
//               <div>
//                 <p className="text-white font-medium text-lg break-words max-w-[220px]">{file ? file.name : "Project Brief.txt"}</p>
//                 <p className="text-gray-400 text-sm">{file ? file.size : "97.23 KB"}</p>
//               </div>
//             </label>
//             <input id="fileInput" type="file" className="hidden" onChange={handleFileSelect} />
//             <div className="mt-6">
//               <p className="text-gray-300 text-sm mb-2">Uploading...</p>
...
//                 />
//               </div>
//               <p className="text-right text-white font-semibold mt-2">{progress} %</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//               <div
//                 key={i}
//                 className="flex-shrink-0 w-80 rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900
